 ...
 * Use the [FragmentCreateAnnouncement.newInstance] factory method to
...
class FragmentCreateAnnouncement : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentCreateAnnouncement.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentCreateAnnouncement().apply {
